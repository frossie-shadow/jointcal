...
void ChipVisitPhotometryMapping::computeParameterDerivatives(MeasuredStar const &measuredStar,
    ...
    // TODO: possible optimization is to merge transformFlux and computeDerivatives,
    ...
    double chipScale = _chipMapping->getTransfo()->apply(measuredStar.x, measuredStar.y, 1);
    double visitScale =
            _visitMapping->getTransfo()->apply(measuredStar.getXFocal(), measuredStar.getYFocal(), 1);
